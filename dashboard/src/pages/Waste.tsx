...
import { Recycle, Trash2, Leaf, Activity, ArrowDown, ArrowUp, TreePine } from 'lucide-react';
import {
    Chart as ChartJS,
    CategoryScale,
    LinearScale,
...
export default function Waste() {
    ...
    const baseLandfill = [1200, 1150, 1300, 1250, 1100, 950, 1050, 1150, 1200, 1180, 1220, 1100];
    const baseRecycled = [800, 850, 900, 950, 800, 700, 750, 850, 900, 880, 920, 850];
    const baseComposted = [400, 420, 450, 480, 400, 350, 380, 420, 450, 440, 460, 420];
