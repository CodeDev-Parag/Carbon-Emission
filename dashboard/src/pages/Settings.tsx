                    ...
                    <div className="flex flex-col gap-6 animate-fade-in-up">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex flex-col gap-2">
                                ...
                                <input type="text" defaultValue="Northwestern Main Campus" className="bg-white border border-gray-200 rounded-xl px-4 py-2.5 text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 shadow-sm" />
                            </div>
                            <div className="flex flex-col gap-2">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <input type="number" defaultValue="22500" className="bg-white border border-gray-200 rounded-xl px-4 py-2.5 text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 shadow-sm" />
                            </div>
                            <div className="flex flex-col gap-2">
                                <label className="text-sm font-medium text-gray-700">Staff Headcount (Constant)</label>
                                <input type="number" defaultValue="4200" className="bg-white border border-gray-200 rounded-xl px-4 py-2.5 text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 shadow-sm" />
                            </div>
                            <div className="flex flex-col gap-2">
                                <label className="text-sm font-medium text-gray-700">Total Built Area (m²)</label>
                                <input type="number" defaultValue="1450000" className="bg-white border border-gray-200 rounded-xl px-4 py-2.5 text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 shadow-sm" />
                            </div>
                        </div>

                        <div className="mt-6 pt-6 border-t border-gray-100 flex justify-end">
                            <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2.5 rounded-full text-sm font-medium shadow-sm transition-colors">Save Constants</button>
                        </div>
                    </div>
                );
            case 'factors':
                                ...
                                <table className="w-full text-sm text-left">
                                    ...
                                    <tbody className="divide-y divide-gray-100 text-gray-700">
                                        <tr className="hover:bg-gray-50/50">
                                            ...
                                            <td className="px-4 py-3 text-gray-500">EPA eGRID (2023)</td>
                                        </tr>
                                        <tr className="hover:bg-gray-50/50">
                                            ...
                                            <td className="px-4 py-3 text-gray-500">DEFRA (2023)</td>
                                        </tr>
                                        <tr className="hover:bg-gray-50/50">
                                            ...
                                            <td className="px-4 py-3"><span className="bg-emerald-50 text-emerald-700 px-2 py-0.5 rounded text-xs font-semibold">Scope 1</span></td>
                                            <td className="px-4 py-3 text-gray-500">EPA GHG Hub (2023)</td>
                                        </tr>
                                        <tr className="hover:bg-gray-50/50">
                    ...
                    <div className="flex flex-col gap-6 animate-fade-in-up">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                                <h4 className="font-semibold text-gray-900 mb-4 flex items-center gap-2"><CheckCircle2 className="w-5 h-5 text-gray-400" /> Confidence Legend</h4>
                            ...
                            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                                <h4 className="font-semibold text-gray-900 mb-4 flex items-center gap-2"><AlertCircle className="w-5 h-5 text-gray-400" /> Missing Data Policy</h4>
                                <div className="text-sm text-gray-600 space-y-3">
                                    ...
                                    <div className="p-3 bg-gray-50 rounded-xl border border-gray-100">
                                        ...
                                        <p className="text-gray-500 mt-1 mt-0.5">Interpolates using the average of the 3 preceding months. Marked with a trailing asterisk (*).</p>
                                    </div>
                                    <div className="p-3 bg-gray-50 rounded-xl border border-gray-100">
                                        <p className="font-medium text-gray-900">No Historical Meter</p>
                                        <p className="text-gray-500 mt-1 mt-0.5">Estimates based on `Building Area (m²) × Regional Average Intensity factor`. Triggers Low Confidence tag.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                return (
                    <div className="flex flex-col gap-6 animate-fade-in-up h-full">
                        <div className="mb-2 flex justify-between items-center">
                            ...
                            <button className="text-xs bg-white border border-gray-200 px-3 py-1.5 rounded-lg text-gray-600 font-medium hover:bg-gray-50 shadow-sm">Export Log</button>
                        </div>
                                ...
                                <table className="w-full text-sm text-left">
                                    ...
                                    <tbody className="divide-y divide-gray-100 text-gray-700">
                                        ...
                                        <tr className="hover:bg-gray-50/50">
                                            ...
                                            <td className="px-4 py-3 text-rose-600 line-through">0.86 (2022)</td>
                                            <td className="px-4 py-3 text-emerald-600 font-medium">0.85 (2023)</td>
                                        </tr>
                                        <tr className="hover:bg-gray-50/50">
                                        ...
                                        <tr className="hover:bg-gray-50/50">
                                            ...
                                            <td className="px-4 py-3 text-rose-600 line-through">ISO 14064</td>
                                            <td className="px-4 py-3 text-emerald-600 font-medium">GHG Protocol</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
            ...
            <div className="w-full flex-1 bg-white border border-gray-200 rounded-[2rem] shadow-sm overflow-hidden flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-64 bg-gray-50/50 border-r border-gray-100 p-6 flex flex-col gap-2 shrink-0">
                    ...
                    <div className="mt-8 p-4 bg-indigo-50/50 rounded-xl border border-indigo-100 text-xs text-indigo-800">
                        <p className="flex items-center gap-1.5 font-semibold mb-1"><BookOpen className="w-3.5 h-3.5" /> Documentation</p>
                        <p className="opacity-80 leading-relaxed">Refer to the Campus Sustainability methodology guide for EF justifications.</p>
                    </div>
                </div>
